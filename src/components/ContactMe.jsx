  ...
  return (
    <div className=" w-10/12 mx-auto">
      ...
      <div className="w-full mx-auto p-4 my-10">
        <div
          className={`flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 transition-all duration-1000 ease-in-out ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          {/* Left Column - Text Content with fade-in animation */}
          <div
            className={`w-full md:w-1/2 text-white transition-all duration-700 delay-300 ${
              isVisible
          ...
          >
            <div className="space-y-6 text-blue-100">
              ...
              <div
                className={`space-y-5 transition-all duration-700 delay-600 ${
                  isVisible
                ...
                <div className="flex items-center gap-3 hover:translate-x-2 transition-transform duration-300">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-teal-100 hover:text-teal-300 transition-colors text-sm md:text-base break-all md:break-normal"
                    >
          ...
          >
            <div
              className="bg-zinc-900 backdrop-blur-md rounded-lg p-6 shadow-xl shadow-blue-800 border border-richblack-100 border-opacity-20   
