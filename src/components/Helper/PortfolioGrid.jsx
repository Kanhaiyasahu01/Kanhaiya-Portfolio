        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-10/12 mx-auto">
            ...
            <div className="h-full relative flex flex-col justify-between ">
              ...
              <div className="w-full flex flex-row-reverse ">
                <div className="items-end">
                  <Link
                    to={"/contact"}
                    className="bg-zinc-900 border border-zinc-700 border-opacity-50 hover:bg-zinc-800 text-white py-3 px-6 rounded-full flex items-center justify-center mx-auto"
                  >
                    Contact Me
                    <span className="ml-2">
                      {" "}
          ...
          <div className="bg-zinc-900 bg-opacity-50 border border-zinc-700 border-opacity-50 rounded-lg p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-lg hover:border-richblue-400 hover:shadow-richblue-500 group">
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <div className="mt-8">
                <button className="bg-zinc-900 border border-zinc-700 border-opacity-50 hover:bg-zinc-800  text-white py-3 px-6 rounded-full flex items-center justify-center mx-auto">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
